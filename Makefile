#############################################################################
# Makefile for building: A5
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Mar 1 15:41:11 2016
# Project:  A5.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile A5.pro
#############################################################################
...
Makefile: A5.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/A51.0.0 || $(MKDIR) .tmp/A51.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/A51.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/A51.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/A51.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/A51.0.0/ && (cd `dirname .tmp/A51.0.0` && $(TAR) A51.0.0.tar A51.0.0 && $(COMPRESS) A51.0.0.tar) && $(MOVE) `dirname .tmp/A51.0.0`/A51.0.0.tar.gz . && $(DEL_FILE) -r .tmp/A51.0.0
